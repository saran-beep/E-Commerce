    ...
    <div className="order-header">
      ...
      <div className="balance-container">
        <div className="order-card">
          ...
          <p className="order-id">Order ID: <span>335465465465426</span></p>
          <p className="order-date">Order date: Nov 10, 2025</p>

          <button className="invoice-btn">Invoice</button>

          <p className="delivery-estimate">
            Estimated delivery: <span>Nov 17, 2025</span>
          </p>
          <p className="last-updated">Last updated on 11 Nov 2025, Tuesday</p>

          {/* Centered animated timeline */}
          <div className="timeline-center">
            ...
            {/* Step 1 */}
            <div className="timeline-event completed left">
              <div className="timeline-content">
                <p className="date">Mon, 10th Nov 2025</p>
                <p className="status">Order Confirmed</p>
                <p className="detail">At Online</p>
              </div>
              <div className="timeline-dot"></div>
            </div>

            {/* Step 2 */}
            <div className="timeline-event completed right">
              <div className="timeline-dot"></div>
              <div className="timeline-content">
                <p className="date">Thu, 11th Nov 2025</p>
                <p className="status">Shipped</p>
                <p className="detail">From warehouse</p>
              </div>
            </div>

            {/* Step 3 */}
            <div className="timeline-event active left">
              <div className="timeline-content">
                <p className="date">Wed, 12th Nov 2025</p>
                <p className="status">In transit</p>
                <p className="detail">To Chennai</p>
              </div>
              <div className="timeline-dot"></div>
            </div>

            {/* Step 4 */}
            <div className="timeline-event pending right">
              <div className="timeline-dot"></div>
              <div className="timeline-content">
                <p className="date">Sat, 15th Nov 2025</p>
                <p className="status">Out of delivery</p>
                <p className="detail">At location</p>
              </div>
            </div>

            {/* Step 5 */}
            <div className="timeline-event pending left">
              <div className="timeline-content">
                <p className="date">Expected by, Mon, 17th Nov 2025</p>
          ...
          <div className="order-footer">
            ...
            <div className="address">
              ...
              <p>#123, xxxx Apt,<br />Chennai - 000000</p>
            </div>
          </div>
        </div>
      </div>
